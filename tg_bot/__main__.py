...
TECHNO_IMG = "https://telegra.ph//file/179a334b000a0fe01a13c.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                TECHNO_IMG,
                PM_START_TEXT.format(escape_markdown(first_name), escape_markdown(bot.first_name), 1742906647),
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       callback_data="help_back".format(bot.username)),
                                                                                   InlineKeyboardButton(text="🧑‍💻My Creator🧑‍💻",
                                                                       url="t.me/MrZbotsupport")],
                                                                                   [InlineKeyboardButton(text="ADD Mr Z TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/GODBOYX/Mr_Z")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Yess , I AM ON DUTY SIR")
