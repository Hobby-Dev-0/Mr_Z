...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "--"
    OWNER_ID = "1742906647"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "GODBOYX"

    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = 'sqldbtype://username:pw@hostname:port/db_name'  # needed for any database modules
    MESSAGE_DUMP = None  # needed to make sure 'save from' messages persist
    GBAN_LOGS = -1001215677310 #Channel ID here with -
    LOAD = []
